...
class CategoryControllerTest {
    ...
    void should_ReturnAllCategories_WhenGetAllCategories() throws Exception {
        // Arrange
        when(agentCategoryService.findAllCategories(any(Pageable.class))).thenReturn(categoryPage);
        ...
        verify(agentCategoryService).findAllCategories(any(Pageable.class));
    }
    ...
    void should_ReturnNotFound_WhenGetCategoryByIdNotFound() throws Exception {
        // Arrange
        when(agentCategoryService.findCategoryById(99L)).thenThrow(new NoSuchElementException("Category not found"));
        ...
        verify(agentCategoryService).findCategoryById(99L);
    }

    @Test
    void should_ReturnCategory_WhenGetCategoryByName() throws Exception {
        // Arrange
        when(agentCategoryService.findCategoryByName("Electronics")).thenReturn(category);
        ...
        verify(agentCategoryService).findCategoryByName("Electronics");
    }

    @Test
    void should_ReturnNotFound_WhenGetCategoryByNameNotFound() throws Exception {
        // Arrange
        when(agentCategoryService.findCategoryByName("Nonexistent")).thenThrow(new NoSuchElementException("Category not found"));
        ...
        verify(agentCategoryService).findCategoryByName("Nonexistent");
    }

    @Test
    void should_ReturnCategoriesBySearch_WhenSearchCategories() throws Exception {
        // Arrange
        when(agentCategoryService.findCategoriesByNameContaining(eq("Elec"), any(Pageable.class))).thenReturn(categoryPage);
        ...
        verify(agentCategoryService).findCategoriesByNameContaining(eq("Elec"), any(Pageable.class));
    }

    @Test
    void should_CreateCategory_WhenPostCategory() throws Exception {
        // Arrange
        when(agentCategoryService.saveCategory(any(Category.class))).thenReturn(category);
        ...
        verify(agentCategoryService).saveCategory(any(Category.class));
    }

    @Test
    void should_UpdateCategory_WhenPutCategory() throws Exception {
        // Arrange
        when(agentCategoryService.updateCategory(eq(1L), any(Category.class))).thenReturn(category);
        ...
        verify(agentCategoryService).updateCategory(eq(1L), any(Category.class));
    }

    @Test
    void should_ReturnNotFound_WhenPutCategoryNotFound() throws Exception {
        // Arrange
        when(agentCategoryService.updateCategory(eq(99L), any(Category.class)))
        ...
        verify(agentCategoryService).updateCategory(eq(99L), any(Category.class));
    }

    @Test
    void should_DeleteCategory_WhenDeleteCategory() throws Exception {
        // Arrange
        doNothing().when(agentCategoryService).deleteCategory(1L);
        ...
        verify(agentCategoryService).deleteCategory(1L);
    }

    @Test
    void should_ReturnNotFound_WhenDeleteCategoryNotFound() throws Exception {
        // Arrange
        doThrow(new NoSuchElementException("Category not found")).when(agentCategoryService).deleteCategory(99L);
        ...
        verify(agentCategoryService).deleteCategory(99L);
    }
} 